    ...
    <div className="section livefeed" id="feed">
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="one-half column">
            <h3 className="feed-multiplier">
              <i className="fas fa-trophy"></i> Latest WRs
            </h3>
            <ul style={{ textAlign: `left`, width: `85%`, margin: `0 auto` }}>
              <li>
                Runner one on <b>map</b> in 1:23.456 (Pure run)
              ...
              <li>
                Runner two on <b>map</b> in 1:23.456 (Noob run)
              </li>
              <li>
                Runner three on <b>map</b> in 1:23.456 (Pure run)
              </li>
              <li>
                Runner four on <b>map</b> in 1:23.456 (Pure run)
              </li>
            </ul>
          </div>
        </div>
